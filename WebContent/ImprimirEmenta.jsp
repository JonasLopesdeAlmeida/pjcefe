		...
		<div class="card">
			<div class="card-body">
					...
					if (id_certificado != 0) {
						...
						ResultSet rs = null;
						{
							...
							try {
								...
								ps = con.prepareStatement("select id_certificado, evento.nome_evento as nome_evento,evento.ementa as ementa, evento.data_evento as data_evento,evento.turno as turno from certificado inner join evento on certificado.id_evento = evento.id_evento where id_certificado=?");
				...
				%>
					...
					<form method="post" action="ServerRelEmenta" name="frmAdd"
