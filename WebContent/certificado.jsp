...
<h1 style="text-align: center;">CERTIFICADO</h1>
  				...
  				<form  method="post" action="ServerRel" name="frmAdd" enctype="multipart/formdata"> 
  				<div class="row">
				<div class="col-sm-3">
  				<label >DATA DE NASCIMENTO:</label>
				<input type="Date" name="datanasc" value="" id="datanasc"  class="form-control"/>
  				</div>
  				
				<div class="col-sm-8">
  				<label >DIGITE O SEU NOME:</label>
				<input type="text" name="nome" value="" id="cpf"  class="form-control"/>
				<br>
  				</div>
  				</div>
