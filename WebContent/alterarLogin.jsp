	...
	<div class="container">
		<div class="card">
			<div class="card-body" >
					...
					if (id_login != 0) {
						...
						ResultSet rs = null;
						{
							...
							try {
								...
								ps = con.prepareStatement("select * from login where id_login = ?");
				...
				<h1 style="text-align: center;">Atualizar Login</h1>

				<form method="post" action="ServerLoginAtualizar" name="frmAdd"
					enctype="multipart/formdata">

					<div class="row">
						<div class="col-sm-12">
							<label>Novo Usuário:</label>
							<input type="hidden" name="id_login" value="<%= rs.getInt("id_login")%>"/>
							 <input type="text"
								name="usuario" 
					...
					<button type="submit" class="btn btn-success btn-block"
						style="width: 100px;">Atualizar</button>
