		...
		<div class="card">
			<div class="card-body">
				...
				%>
					...
					<form method="post" action="ServerEscolaDeletar" name="frmAdd"
						...
						<div class="col-sm-6">
							...
							<input type="hidden" name="id_escola" value="<%= rs.getInt("id_escola")%>"/>
							 <input type="text"
								...
								class="form-control" readonly="true"value="<%=rs.getString("instituicao")%>"/>
						</div>

						<div class="col-sm-6">
							<label>MODALIDADE:</label> <input type="text" name="modalidade" class="form-control"
								readonly="true" value="<%=rs.getString("modalidade")%>"></input> <br>
						</div>
